...
```
[https://YourDirectionsApiURLGoesHere](https://maps.googleapis.com/maps/api/directions/json?origin=Shenandoah+National+Park&destination=Gettysburg,+PA&key=AIzaSyCM-WWHYHIKY-do4kquMy9Z4wQaQx51AuE)
```
